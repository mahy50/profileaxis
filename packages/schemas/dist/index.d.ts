import type { ProjectDocument, IntentDsl, ConfirmationDsl, DraftDsl, ResolvedDsl, StructuralNode, JointNode, CheckIssue, CommandEntry } from '@profileaxis/domain';
export declare const SCHEMA_VERSION = "1.0.0";
export { SCHEMA_VERSION as DOMAIN_SCHEMA_VERSION } from '@profileaxis/domain';
export type { ProjectDocument, IntentDsl, ConfirmationDsl, DraftDsl, ResolvedDsl, StructuralNode, JointNode, CheckIssue, CommandEntry, };
...
export type EditAction = 'resizeOverall' | 'resizeBay' | 'insertLevel' | 'removeLevel' | 'moveLevel' | 'toggleBrace' | 'replaceProfileSeries' | 'addBeam' | 'removeBeam' | 'insertBay' | 'removeBay' | 'restoreSnapshot';
